...
public class ApiTest {
    String token = "wU5BUEknz31LE0qlTd6BRdPOGXe7Qi2wO3LX";
    @BeforeClass
    ...
    {
        return new Object[][] {{"Kristina", "Verenich", "1999-12-07","female",
                "1234@gmail.com", "+8 (999) 111-78-44", "active"}};
    }
    @Test(dataProvider = "new_user")
    public void test1_3(String first_name, String last_name, String dob, String
            gender, String email, String phone, String Status)
    {
        Post post1 = new Post(first_name, last_name, gender,dob, email, phone,
                Status);
    ...
    public Object[][] ID_2()
    {
        return new Object[][] {{1788, "David 222", "Smithson", "male", "1937-01-11",
                "less.awone@example.org", "9090 9090 9090" , "active"}};
    }
    @Test(dataProvider = "ID_2")
    public void test1_5(int ID,String first_name, String last_name, String gender,
                        String dob, String email, String phone, String Status )
    {
        Post post = new Post( first_name, last_name,gender, dob, email, phone,
                Status);
    ...
    {
        return new Object[][] {{"Kristina", "Verenich", "1999-12-07","female",
                "1234@gmail.com", "+8 (902) 111-78-44", "active"}};
    }
    @Test(dataProvider = "invalid_body")
    public void test2_2(String first_name, String last_name, String dob, String
            gender, String email, String phone, String Status)
    {
        Post post1 = new Post(first_name, last_name, gender,dob, email, phone,
                Status);
